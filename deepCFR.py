...
def traverse(history, i, curr_player, t, val_mem, pol_mem, val1_net, pol_net):
    ...
    if curr_player == i:
        ...
        for j in range(6):
            ...
            r = traverse(new_history, i, get_next_turn(new_history), t, val_mem, pol_mem, val1_net, pol_net)
        ...
        if curr_player == 'c':
            ...
            return traverse(next_history, i, get_next_turn(next_history), t, val_mem, pol_mem, val1_net, pol_net)
